Pod::Spec.new do |s|
  ...
  s.screenshots      = "https://raw.githubusercontent.com/zliw/MWAwesomeFontWrappers/master/screenshots/screenshot.png"
  s.license          = 'MIT'
  s.author           = { "Martin Wilz" => "github@wilz.de" }
  s.source           = { :git => "https://github.com/zliw/MWAwesomeFontWrappers.git", :tag => "0.1.1" }
